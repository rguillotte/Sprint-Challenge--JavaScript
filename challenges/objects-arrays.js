...
graduates.forEach((graduates) => {
  let unis = graduates.university;
  return universities.push(unis);
})
...
graduates.forEach((graduates) => {
  let firstEmail = ` ${graduates.first_name} ${graduates.email}`;
  return contactInfo.push(firstEmail);
})
...
zooAnimals.forEach((animal) => {
  let nameSciName = `Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}.`;
  return animalNames.push(nameSciName);
})
...
zooAnimals.map((animal) => {
  let animalLower = animal.animal_name.toLowerCase();
  return lowerCase.push(animalLower);
})
